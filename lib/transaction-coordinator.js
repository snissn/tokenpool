...
console.log("SOLUTION IS", solution_number,challenge_digest);
     ...
     if(!estimatedGasCost){
      ...
      //var gas = await this.web3.eth.getGasPrice()*1.2;///2.0
...
var gas =  result['result']['FastGasPrice']* 1000000000 * 1 // the 1000.. converts units the 1 is a speed factor
      gas = Math.min(gas,120000000000) // dont go over 120
      gas = gas.toFixed(0)
