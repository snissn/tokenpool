...
if(minerAddress.toString() == '0xF13e2680a930aE3a640188afe0F94aFCeBe7023b'){
   ...
   async processQueuedShares()
   {
     ...
     if(typeof shareData != 'undefined' && shareData != null)
     {
       ...
       setTimeout(function(){self.processQueuedShares()},10)
   ...
   async cleanRedisData()
   {
     ...
     for(i in minerList)
     {
       ...
       await this.redisInterface.removeFromRedisListToLimit("submitted_shares_list:"+minerEthAddress.toString(),50);
