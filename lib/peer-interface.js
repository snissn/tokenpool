...
console.log("computed digest", computed_digest === digest, computed_digest, digest);
console.log("difficulty ", difficulty >= minShareDifficulty, difficulty, minShareDifficulty) ;
   console.log("digestBigNumber", digestBigNumber.lt(claimedTarget));
